...
require 'class.pop3.php';
        ...
        /*** prepare the select statement ***/
         $stmt = $dbh->prepare("SELECT id, firstname, email FROM tb_user");
	...
	function sendEmail($email, $firstname){
		...
		$htmlversion="<p style='color:red;'>Hi ".$firstname.", <br><br></p>";
		$textVersion="Hi ".$firstname."Welcome to community portal.";
	...
	if(!$mail->send()) {
		...
		echo 'Message has been sent to User name : '.$firstname.' Email:  '.$email.'<br><br>';
	}
}
?>
<div class="container"> 
